		...
		verifyCurrentAccountOpeningMudarabahCAAPage.sendKeysSearchBarTextField(data.getMenu())
													.switchFormAreaFrame()
													 .sendKeysAccountIdTextField(data.getAccountid())
													  .pressGoButton()
													   .navigateAdditionalDetailsSideTabMenu()
													    .navigateProfitDetailsSideTabMenu()
													     .navigateTaxDetailsSideTabMenu()
													      .navigateSchemeDetailsSideTabMenu()
													       .navigateRelatedPartyDetailsSideTabMenu()
													        .navigateGeneralDetailsSideTabMenu()
													         .navigateMisDetailsSideTabMenu()
													          .pressSubmitButton()
													           .acceptWarning()
													            .scrollUpToMenuName();
		}
