...
public class ABEVerifyCurrentAccountOpeningMudarabahCAAPage {
	...
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateAdditionalDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, additionalDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateProfitDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, profitDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateTaxDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, taxDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateSchemeDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, schemeDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateRelatedPartyDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, relatedPartyDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateGeneralDetailsSideTabMenu() throws Exception {
		PageFunctionUtils.clickOnElement(driver, generalDetailsSideTab);
		return this;
	}
	
	@Step("Side tab navigation")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage navigateMisDetailsSideTabMenu() throws Exception {
	...
	@Step("Accept warning")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage acceptWarning() throws Exception {
		PageFunctionUtils.acceptWarning(driver);
		return this;
	}
	
	@Step("Scroll up to menu name")
	public ABEVerifyCurrentAccountOpeningMudarabahCAAPage scrollUpToMenuName() throws Exception {
