...
public class ABEOpenCurrentAccountMudarabahCAAPage {
	...
	@Step("Accept warning")
	public ABEOpenCurrentAccountMudarabahCAAPage acceptWarning() throws Exception {
		PageFunctionUtils.acceptWarning(driver);
		return this;
	}
	
	@Step("Scroll up to menu name")
	public ABEOpenCurrentAccountMudarabahCAAPage scrollUpToMenuName() throws Exception {
		PageFunctionUtils.scrollUpToElement(driver, menuNameTextBox);
		return this;
	}
	
	@Step("Get account id")
	public ABEOpenCurrentAccountMudarabahCAAPage getAccountId() throws Exception {
		PageFunctionUtils.waitOnElement(driver, accountIdSuccessMessage);
		acId = PageFunctionUtils.getText(driver, accountIdSuccessMessage).substring(53);
		return this;
	}
